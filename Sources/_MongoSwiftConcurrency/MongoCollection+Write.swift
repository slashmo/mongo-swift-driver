...
extension MongoCollection {
    ...
    public func replaceOne(
        ...
        try await self.replaceOne(filter: filter, replacement: replacement, options: options, session: session).get()
    }
    ...
    public func updateOne(
        ...
        try await self.updateOne(filter: filter, update: update, options: options, session: session).get()
    }
    ...
    public func updateMany(
        ...
        try await self.updateMany(filter: filter, update: update, options: options, session: session).get()
    }
